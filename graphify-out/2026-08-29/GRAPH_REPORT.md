...
## Corpus Check
- 235 files · ~69,106 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1583 nodes · 3105 edges · 105 communities (68 shown, 37 thin omitted)
...
Cohesion: 0.12
Nodes (12): CurrentUser, Get, ProfileController, Body, Controller, Delete, Get, HttpCode (+4 more)
...
Cohesion: 0.14
Nodes (13): AdminGuard, Injectable, BanStatusGuard, Injectable, PermissionGuard, Injectable, PERM_KEY, AuthedRequest (+5 more)
...
Cohesion: 0.12
Nodes (17): AdminModule, Module, AppModule, Module, AuthModule, Module, BotModule, Module (+9 more)
...
Cohesion: 0.08
Nodes (22): App(), AppLayout(), HomeGate(), PrivacyPage, PublishPage, BannedGate(), periodText(), BottomNav() (+14 more)
...
Cohesion: 0.09
Nodes (40): ApiError, chunks(), event_ids(), event_keyboard(), plan_keyboard(), Any, Turning the model's answer into a Telegram message. The model never emits URLs…, Referenced ids, in the order the model mentioned them, deduplicated. (+32 more)

### Community 26 - "UserAccountPage.tsx"
Cohesion: 0.14
Nodes (11): UserAccountPage, BanModal(), BanModalProps, OPTIONS, ROLE_BADGE, UsersManagerProps, banPeriodText(), STATUS_LABEL (+3 more)

### Community 27 - "UpdateEventDto"
Cohesion: 0.14
Nodes (13): deriveAgeLabel(), deriveShortDesc(), IsArray, IsBoolean, IsIn, IsInt, IsOptional, IsString (+5 more)
...
Cohesion: 0.13
Nodes (12): SuperAdminGuard, Injectable, CapacityController, Controller, Get, UseGuards, CapacityModule, Module (+4 more)
...
Cohesion: 0.12
Nodes (15): CreateEducationTrackDto, IsOptional, IsString, URL_OPTS, CreateMaterialDto, IsArray, IsInt, IsOptional (+7 more)
...
### Community 39 - "traffic.module.ts"
Cohesion: 0.08
Nodes (22): TrafficQueryDto, IsInt, IsOptional, Max, Min, Type, TrafficAdminController, Controller (+14 more)
...
Cohesion: 0.13
Nodes (27): api(), bishkek_now(), bishkek_today(), Catalog, deadline_in_days(), embedding_text(), is_open(), matches() (+19 more)

### Community 42 - "CreateEventDto"
Cohesion: 0.16
Nodes (10): CreateEventDto, IsArray, IsBoolean, IsIn, IsInt, IsOptional, IsString, IsUrl (+2 more)

### Community 43 - "types.ts"
Cohesion: 0.11
Nodes (28): SettingsPage, AuthContext, AuthContextValue, useAdminUser(), useAdminUsers(), api, authHeader(), reportNetworkTrouble() (+20 more)
...
### Community 45 - "tools.py"
Cohesion: 0.09
Nodes (44): parse_date(), fetch_all(), fetch_one(), Any, site_url(), _ctx(), get_event(), link_hint() (+36 more)

### Community 46 - "execute"
Cohesion: 0.29
Nodes (11): execute(), _drop_thread(), _new_thread_id(), The three-day memory rule. Барс keeps a conversation for 72 hours since the…, Erase a conversation. Prefers the checkpointer's own delete so we are not…, Return (thread_id, started_fresh) and mark the chat as active right now., /reset — forget now instead of waiting three days., Nightly: drop the checkpoints of chats that went quiet and never came back. (+3 more)

### Community 47 - "SupabaseService"
Cohesion: 0.12
Nodes (9): Inject, HealthController, Controller, Get, SkipThrottle, HealthModule, Module, SupabaseService (+1 more)
...
Cohesion: 0.14
Nodes (7): Body, Param, Post, BotService, Injectable, TelegramLinkService, Injectable
...
- **Why does `SupabaseService` connect `SupabaseService` to `admin.service.ts`, `AuthController`, `TelegramLinkService`, `traffic.module.ts`, `events.service.ts`, `CreateSubmissionDto`, `traffic.service.ts`, `news.service.ts`, `ratings.controller.ts`, `supabase-auth.guard.ts`, `TrafficCleanupService`, `app.module.ts`, `users-admin.service.ts`, `mappers.ts`, `SupabaseAuthGuard`, `FavoritesService`, `capacity.controller.ts`, `profile.controller.ts`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `CurrentUser` to `AuthController`, `CreateSubmissionDto`, `ratings.controller.ts`, `supabase-auth.guard.ts`, `users-admin.service.ts`, `FavoritesService`, `profile.controller.ts`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `useAuth` to `GridPage.tsx`, `AdminPage.tsx`, `AnalyticsPage.tsx`, `types.ts`, `useEducation.ts`, `AuthPage.tsx`, `UsersPage.tsx`, `constants.ts`, `AuthPage`, `UserAccountPage.tsx`, `ProfilePage.tsx`?**
